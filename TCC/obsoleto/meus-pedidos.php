...
<head>
    ...
    <!-- Title  -->
    <title>Laineg - Tente uma nova Perspectiva | Home</title>
                                        ...
                                        foreach($read_pedido as $read_pedido_view){
                                            ...
                                            <tr>
                                                <td class="cart_product_desc">
                                                    <h5> '.$read_pedido_view['pedido_id'].'</h5>
                                                </td>
                                                <td class="cart_product_desc">
                                                    <h5> '.$read_pedido_view['pedido_data_hora'].'   </h5>
                                                </td>
                                                <td class="price">
                                                    <span>'.number_format($read_pedido_view['pedido_valor'],2,',','.').'</span>
                                                </td>
                                                <td class="cart_product_desc">
                                                    <h5> '.$status_pedido.'   </h5>
                                                </td>
                                                        <td class="cart_product_desc">
                                                    <h5> <a href="deletar-prod-carrinho.php?id='.$id_produto_carrinho.'">Deletar</a</h5>
                                                </td>
                                                    </div>
                                                </td>
                                            </tr>';
