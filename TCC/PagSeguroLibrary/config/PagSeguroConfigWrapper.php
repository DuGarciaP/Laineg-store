...
class PagSeguroConfigWrapper
{
     ...
     */
    const PAGSEGURO_ENV = PAG_SEGURO_ENV;
    /**
     *
     */
    const PAGSEGURO_EMAIL = PAG_SEGURO_EMAIL;
    /**
     *
     */
    const PAGSEGURO_TOKEN_PRODUCTION = PAG_SEGURO_TOKEN_PRODUCTION;
    /**
     *
     */
    const PAGSEGURO_TOKEN_SANDBOX = PAG_SEGURO_TOKEN_SANDBOX;
    /**
     *
     */
    const PAGSEGURO_APP_ID_PRODUCTION = PAG_SEGURO_APP_ID_PRODUCTION;
    /**
     *
     */
    const PAGSEGURO_APP_ID_SANDBOX = PAG_SEGURO_APP_ID_SANDBOX;
    /**
     *
     */
    const PAGSEGURO_APP_KEY_PRODUCTION = PAG_SEGURO_APP_KEY_PRODUCTION;
    /**
     *
     */
    const PAGSEGURO_APP_KEY_SANDBOX = PAG_SEGURO_APP_KEY_SANDBOX;
    /**
     * UTF-8, ISO-8859-1
     */
    const PAGSEGURO_CHARSET = PAG_SEGURO_CHARSET;
    /**
     *
     */
    const PAGSEGURO_LOG_ACTIVE = PAG_SEGURO_LOG_ACTIVE;
    /**
     * Informe o path completo (relativo ao path da lib) para o arquivo, ex.: ../PagSeguroLibrary/logs.txt
     */
    const PAGSEGURO_LOG_LOCATION = PAG_SEGURO_LOG_LOCATION;
